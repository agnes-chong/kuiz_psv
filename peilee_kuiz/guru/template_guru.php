...
<div class="w3-bar w3-pale-yellow">
  ...
  <a href='../logout.php' class="w3-bar-item w3-button w3-right w3-large w3-dm-sans" script src='https://cdn.lordicon.com/libs/mssddfmo/lord-icon-2.1.0.js'></script>
<lord-icon
...
<!-- footer -->
<div class="w3-container w3-pale-yellow">
  <p>Hak Cipta Terpelihara : Chong Pei Lee 5 Wira </p>
  <p>AMARAN : Dilarang sama sekali mengambil sebarang unsur daripada laman sesawang ini tanpa kebenaran</P>
</div>
